...
const msg = {
    debug: (id: string, msg: string) => {if (process.env.DEBUG) console.log("[\x1b[92m"+new Date().toLocaleString()+"\x1b[0m][\x1b[90mDBG\x1b[0m][\x1b[31m"+id+"\x1b[0m]\x1b[90m " + msg + "\x1b[0m")},
